...
public interface TelemetryProvider {
    ...
    void recordSpan(String name, Map<String, String> attributes);
...
class NoOpTelemetryProvider implements TelemetryProvider {
    @Override public void recordSpan(String name, Map<String, String> attributes) {}
    @Override public void recordMetric(String name, double value, Map<String, String> tags) {}
