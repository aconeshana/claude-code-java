...
public class VertexClient implements LlmClient {
    ...
    @SuppressWarnings("PMD.UnusedFormalParameter") // Stub preserves the real transport's request-shaped seam.
    private Iterator<StreamEvent> createStubStream(CreateMessageRequest request) {
        ...
        List<StreamEvent> events = List.of(
            ...
            new StreamEvent.ContentBlockStart(0, new TextBlock("Vertex AI streaming stub")),
