...
public record ApiMessage(
    ...
    /** Response without refusal detail — every stop reason other than {@code refusal}. */
    public ApiMessage(String id, String type, String role, List<ContentBlock> content,
                      String model, String stopReason, String stopSequence, Usage usage) {
        this(id, type, role, content, model, stopReason, stopSequence, usage, null);
    }
    ...
    public static class Builder {
        ...
        public Builder stopDetails(StopDetails stopDetails) { this.stopDetails = stopDetails; return this; }
