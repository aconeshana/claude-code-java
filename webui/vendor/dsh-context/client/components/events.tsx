/**
  * Glyphs: inject/model-switch reuse the harness's shared icon set (`@primitives`, a platform seed word);
...
import { IconBranchOutline16, IconPlusOutline16 } from '@primitives'
