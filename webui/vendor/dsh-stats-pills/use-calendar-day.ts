// Vendored verbatim from ui-chat/src/client/chat/use-calendar-day.ts (pinned
// dsh commit): component-local calendar-day tick. Memoized message rows keep
// stable props across midnight, so the IconActions clock needs a local day
// seat that re-fires at the next local midnight.
